...
export class MarijuanaComponent {
  ...
  @Select(ThemeState.homePage) home_page$: Observable<Marijuana>;
  @Select(CategoryState.category) category$: Observable<CategoryModel>;
  @Select(BrandState.brands) brand$: Observable<Select2Data>;

  public form: FormGroup;
  public page_data: Marijuana;
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePage({ slug: "marijuana" }));
  ...
  patchForm() {
    this.home_page$.subscribe(homePage => {
            ...
            banner: {
              banner_1: {
                ...
                redirect_link: {
                  ...
                  link_type: homePage?.content?.offer_banner?.banner?.banner_1?.redirect_link?.link_type,
                  product_ids: homePage?.content?.offer_banner?.banner?.banner_1?.redirect_link?.product_ids
                }
              },
              banner_2: {
                ...
                redirect_link: {
                  ...
                  link_type: homePage?.content?.offer_banner?.banner?.banner_2?.redirect_link?.link_type,
                  product_ids: homePage?.content?.offer_banner?.banner?.banner_2?.redirect_link?.product_ids
                }
              },
            },
          },
      ...
      homePage?.content?.details_section?.banners?.forEach((banner: Banners) =>
  ...
  selectDetailsSectionArray(url: string, index: number) {
    this.detailsSectionArray.at(index).get('image_url')?.setValue(url ? url : null);
  }
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: Marijuana) {
    const result: number[] = [];
