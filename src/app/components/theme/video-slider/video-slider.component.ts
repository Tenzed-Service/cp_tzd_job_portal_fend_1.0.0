...
import { Banners, VideoSlider } from '../../../shared/interface/theme.interface';
...
export class VideoSliderComponent {
  ...
  @Select(ThemeState.homePage) home_page$: Observable<VideoSlider>;
  @Select(CategoryState.category) category$: Observable<CategoryModel>;
  @Select(BrandState.brands) brand$: Observable<Select2Data>;

  public form: FormGroup;
  public page_data: VideoSlider;
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePage({ slug: "video_slider" }));
          ...
          collection_banner: {
            banner_1: {
              ...
              redirect_link: {
                ...
                product_ids: homePage?.content?.collection_banner?.banner_1?.redirect_link?.product_ids
              }
            },
            banner_2: {
              ...
              redirect_link: {
                ...
                product_ids: homePage?.content?.collection_banner?.banner_2?.redirect_link?.product_ids
              }
            },
            banner_3: {
              ...
              redirect_link: {
                ...
                product_ids: homePage?.content?.collection_banner?.banner_3?.redirect_link?.product_ids
              }
            }
          },
          category_product: {
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: VideoSlider) {
    const result: number[] = [];
