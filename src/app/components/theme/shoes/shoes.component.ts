...
import { Banners, Shoes } from '../../../shared/interface/theme.interface';
...
export class ShoesComponent {
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePage({ slug: "shoes" }));
          ...
          about_banner: {
            ...
            collection_banner: {
              banner_1: {
                ...
                redirect_link: {
                  link: homePage?.content?.about_banner?.collection_banner?.banner_1?.redirect_link?.link,
                  link_type: homePage?.content?.about_banner?.collection_banner?.banner_1?.redirect_link?.link_type,
                  product_ids: homePage?.content?.about_banner?.collection_banner?.banner_1?.redirect_link?.product_ids
                }
              },
              banner_2: {
                ...
                redirect_link: {
                  link: homePage?.content?.about_banner?.collection_banner?.banner_2?.redirect_link?.link,
                  link_type: homePage?.content?.about_banner?.collection_banner?.banner_2?.redirect_link?.link_type,
                  product_ids: homePage?.content?.about_banner?.collection_banner?.banner_2?.redirect_link?.product_ids
                }
              },
            },
          },
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: Shoes) {
    const result: number[] = [];
