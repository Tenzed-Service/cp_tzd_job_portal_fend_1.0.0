...
import { Banners, FashionSix } from '../../../../shared/interface/theme.interface';
...
export class Fashion6Component {
  ...
  @Select(ThemeState.homePage) home_page$: Observable<FashionSix>;
  ...
  constructor(private store: Store,
    ...
    this.store.dispatch(new GetHomePage({slug: "fashion_six"}));
  ...
  ngOnInit() {
    const home_page$ = this.store.dispatch(new GetHomePage({ slug: "fashion_six" }));
            ...
            offer_banner: {
              ...
              banner_5: {
                ...
                redirect_link: {
                  ...
                  product_ids: homePage?.content?.offer_banner?.banner_5?.redirect_link?.product_ids
                }
              },
              banner_6: {
                ...
                redirect_link: {
                  ...
                  product_ids: homePage?.content?.offer_banner?.banner_6?.redirect_link?.product_ids
                }
              },
            },
            products_list_1: {
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: FashionSix) {
    const result: number[]= [];
