...
export class Marketplace4Component {
  ...
  @Select(ThemeState.homePage) home_page$: Observable<MarketplaceFour>;
          ...
          product_banner_1: {
            ...
            left_panel: {
              ...
              redirect_link: {
                ...
                product_ids: homePage?.content?.product_banner_1?.left_panel?.redirect_link?.product_ids,
              },
            },
            right_panel: {
          ...
          product_banner_2: {
            ...
            center_panel: {
              banner_1: {
                ...
                redirect_link: {
                  link: homePage?.content?.product_banner_2?.center_panel.banner_1?.redirect_link?.link,
                  link_type: homePage?.content?.product_banner_2?.center_panel.banner_1?.redirect_link?.link_type,
                  product_ids: homePage?.content?.product_banner_2?.center_panel.banner_1?.redirect_link?.product_ids
                }
              },
              banner_2: {
                ...
                redirect_link: {
                  link: homePage?.content?.product_banner_2?.center_panel.banner_2?.redirect_link?.link,
                  link_type: homePage?.content?.product_banner_2?.center_panel.banner_2?.redirect_link?.link_type,
                  product_ids: homePage?.content?.product_banner_2?.center_panel.banner_2?.redirect_link?.product_ids
                }
              },
            },
            right_panel: {
          ...
          product_banner_3: {
            ...
            left_panel: {
              ...
              redirect_link: {
                ...
                product_ids: homePage?.content?.product_banner_3?.left_panel?.redirect_link?.product_ids,
              },
            },
            right_panel: {
